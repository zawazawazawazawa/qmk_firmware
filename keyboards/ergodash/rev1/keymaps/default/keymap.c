...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_QWERTY] = LAYOUT( \
      ...
      KC_GRV,KC_LGUI,KC_LALT, LOWER, KC_LGUI,    KC_SPC ,_______,       THINKING_FACE_TYPE, KC_ENT,  KC_ESC,    KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT  \
  ),
  ...
  [_LOWER] = LAYOUT(
    ...
    KC_TAB,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_DEL ,                        KC_BSPC, KC_MS_LEFT, KC_MS_DOWN,   KC_MS_UP, KC_MS_RIGHT,KC_MS_BTN1, KC_MS_BTN2, \
    KC_LSFT, KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_SPC ,                        KC_ENT , KC_N, KC_MS_WH_DOWN, KC_MS_WH_UP,   KC_GT,   KC_QUES, KC_RSFT, \
    KC_LCTL, KC_LGUI, KC_LALT, LOWER,            LOWER,   KC_SPC ,KC_DEL,        X(THINKING_FACE),KC_ENT , RAISE,            KC_HOME, KC_PGDN, KC_PGUP, KC_END   \
  ),
