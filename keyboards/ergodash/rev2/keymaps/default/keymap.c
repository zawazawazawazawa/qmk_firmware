...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   */
  [_QWERTY] = LAYOUT( \
    KC_ESC,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_MINS,                        KC_RBRC, KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_BSLS, \
    ...
    KC_GRV, KC_LGUI, KC_LALT, EISU,           KC_LGUI,    KC_SPC ,LOWER,          KC_SPC,KC_ESC , RAISE,            KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT  \
  ),
